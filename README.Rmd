...
To add organization-specific color scheme that does not yet exist in the package, open `colors.r`, and add a section for your org that defines the official colors, a color palette with those colors, and a theme function. For example
