...
```{r fig.height=7*13 /20}
g + theme_pub( type='scatter', base_size=12, facet=T, colors='yale')
...
g2 = g + theme_pub(type='scatter', base_size=12, facet=T, colors='yale')
g3 = g + theme_pub(type='scatter', base_size=12, facet=T, colors='cmu' )
#g2 = g + theme_yale(type='scatter', base_size=12, facet=T)
#g3 = g + theme_cmu(type='scatter' , base_size=12, facet=T)
